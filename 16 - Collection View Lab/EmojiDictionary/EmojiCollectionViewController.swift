...
class EmojiCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        // Each row in the collection is represented by a group that is full width
        // and has a fixed height of 70. Each group contains a single item that
        // fills the group's bounds.
